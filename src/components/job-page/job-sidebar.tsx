...
//       negotiable: Boolean(searchParams.get("negotiable")) || false,
//     },
//   });
...
//               label="location from list"
//               options={bangladeshDistricts}
//             />
//             <ComboboxForSelection
//               label="departments from list"
//               options={!isDepartmentsLoading && departments?.data}
//             />
//             <ComboboxForSelection
//               label="industry from list"
//               options={!isIndustriesLoading && industries?.data}
//             />
//             <FloatingLabelInput
//               name="minExperience"
      ...
      <div className="py-5 px-4">
        <FormProvider {...methods}>
          ...
          >
            ...
            <ComboboxForSelection
              label="Department"
              options={!isDepartmentsLoading && departments?.data ? departments.data : []}
              name="department"
            />
            <ComboboxForSelection
              label="Industry"
              options={!isIndustriesLoading && industries?.data ? industries.data : []}
              name="industry"
            />
            <FloatingLabelInput
              name="minExperience"
